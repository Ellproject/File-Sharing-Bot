...
**If you need any more modes in repo or If you find out any bugs, mention in [@Ellproject](https://www.telegram.dog/kocengmars)**
...
**Thanks to [Erich](https://t.me/ErichDaniken) and his [Ellproject](https://t.me/Ellproject) for this Video**
...
#### Deploy in your VPS
````bash
git clone https://github.com/Ellproject/File-Sharing-Bot
cd File-Sharing-Bot
...
* `START_MESSAGE` Optional: start message of bot, use HTML and <a href='https://github.com/Ellproject/File-Sharing-Bot'>fillings</a>
...
* `CUSTOM_CAPTION` put your Custom caption text if you want Setup Custom Caption, you can use HTML and <a href='https://github.com/KocengMarsUBOT/File-Sharing-Bot'>fillings</a> for formatting (only for documents)
